...
const Contact = () => {
  return (
    <div className="bg-gradient-to-b bg-redd text-white w-full">
      {" "}
      <br />
      <br />
            ...
            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <form>
                ...
                <button
                  ...
                  class="mb-6 inline-block w-full rounded bg-gradient-to-r bg-transparent px-6 pt-2.5 pb-2 text-white text-xs font-medium uppercase leading-normal shadow-md transition duration-150 ease-in-out transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring focus:ring-offset-2 active:bg-blue-600 active:ring-active-ring-color"
                >
                  Send
                </button>
              </form>
